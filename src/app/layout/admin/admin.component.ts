...
import {BadgeItem, ChildrenItems, MainMenuItems, Menu, MenuItems} from '../../shared/menu-items/menu-items';
import {BasicLoginService} from '../../pages/auth/login/basic-login/basic-login.service';
...
export class AdminComponent implements OnInit {
  ...
  configOpenRightBar: string | undefined;
...
/**/
  ...
  onResize(event: { target: { innerHeight: string; innerWidth: number; }; }) {
